    ...
    var extraTabs = {
        ...
        global_add_image_tabs: function()
        {
            ...
            if ( typeof window.thumbnailPurge != undefined ) { 
                addPortletLink('p-tb', wgScript + '?title=' + this.tab_ns_image + this.title + '&action=purge', tab_purge, 'ca-purge');
                addPortletLink('p-tb', wgScriptPath + '/thumb.php?w=800&f=' + this.title, tab_thumbPurge, 'ca-thumbpurge');
            } else {
