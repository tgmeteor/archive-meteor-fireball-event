...
if (typeof(AjaxTranslations) == 'undefined' && typeof(window.disableAjaxTranslation) == 'undefined' ) {
    ...
    var AjaxTranslations = {
        ...
        loadAjaxTranslation: function(evt) {
            ...
            this.lastLayoutTemplate = $j('[title='+ templateName +']').parents('.layouttemplate');

            // try to find encoded template args, if supplied (EXPERIMENTAL)
            var templateArgs = "";
            this.lastLayoutTemplate.children('.layouttemplateargs').each(function (index){
